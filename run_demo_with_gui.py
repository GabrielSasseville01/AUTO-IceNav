#!/usr/bin/env python
"""
Wrapper script to run the demo with real-time visualization.
Uses TkAgg backend which is more reliable than Qt.
"""
import os
# Set matplotlib backend to TkAgg BEFORE importing matplotlib or any plotting code
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Ship ice navigation demo with GUI')
    ...
    print('Running with TkAgg backend (real-time visualization enabled)')
    print('Press ESC in the plot window to exit early')
    ...
    demo(cfg_file=args.planner_config_file,
         ...
         start=args.start,
         goal=args.goal,
         show_anim=True,  # Enable animation
